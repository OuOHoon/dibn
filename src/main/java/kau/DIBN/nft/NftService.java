...
public class NftService {
    ...
    public int NftMint(WalletDTO wallet, Item item) throws IOException, CipherException, TransactionException {
        ...
        String contAddr = "0x6e07671E1bfB4FC7116417AAFD0A1315B6206a72";
        ...
        try {
            ...
            System.out.println(tokenId.get(0));
            System.out.println(tokenId.get(0).getValue());
            return Integer.parseInt(tokenId.get(0).getValue().toString());     //발행 후 토큰아이디 받아와 반환. 실패시 -1 반환
                                                                                //Biginteger->integer casting 안되므로 문자로 바꿔준 뒤 parseInt
